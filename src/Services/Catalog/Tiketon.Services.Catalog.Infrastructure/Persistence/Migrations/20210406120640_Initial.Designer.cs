...
namespace Tiketon.Services.Catalog.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210406120640_Initial")]
            ...
            modelBuilder.Entity("Tiketon.Services.Catalog.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "Вас ждёт колоссальный живой звук в исполнении симфонического оркестра и смешанного хора под видео ряд из лучших моментов.",
                            ImageUrl = "https://ticketon.kz/media/upload/23206u45664_ne-prosto-orchestra-saundtreki-naruto-avatar.jpeg",
                        ...
                        new
                        {
                            ...
                            Description = "Паганини среди поп-звезд и Джими Хендрикс среди скрипачей, немецкий скрипач-виртуоз David Garrett - международная суперзвезда, которая стирает границы между Моцартом и группой Metallica.",
                        ...
                        new
                        {
                            ...
                            Description = "«Легенда о любви» - сказка, корни которой уходят в глубину веков. Она родилась на выжженной солнцем земле Востока и не раз становилась объектом литературных обработок. Зрители впервые увидели спектакль «Легенда о любви» 58 лет назад в Мариинском театре.",
                        ...
                        new
                        {
                            ...
                            Description = "Балет «Султан Бейбарс» - необычайно красивый, поразительно захватывающий рассказ о головокружительном пути к вершинам славы и власти. Такой путь всегда требует жертв во имя служения высшим целям.",
                        ...
                        new
                        {
                            ...
                            Description = "Мало кто из современных авторов способен читать свои произведения с таким подлинно артистическим мастерством. Два часа пролетают незаметно: Дина Рубина легко держит внимание зала, ее непринужденная интонация, юмор, драматический накал чтения захватывает зрителей и не отпускает до последней минуты встречи.",
