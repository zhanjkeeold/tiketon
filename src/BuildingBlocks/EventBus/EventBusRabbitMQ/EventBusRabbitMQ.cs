...
using Tiketon.BuildingBlocks.EventBus.Extensions;

namespace Tiketon.BuildingBlocks.EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        private const string BROKER_NAME = "tiketon_event_bus";
        private const string AUTOFAC_SCOPE_NAME = "tiketon_event_bus";
